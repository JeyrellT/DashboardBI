...
function createPercentileBarChart(containerId, data) {
    ...
    console.log("Datos para percentile chart:", data); // Depuración
    ...
    // Redondear los datos para eliminar decimales
    const processedData = data.map(item => ({
        ...item,
        Percentil: Math.round(item.Percentil)
    }));
    ...
    try {
        const chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Percentil',
                    data: processedData.map(item => item.Percentil),
                    backgroundColor: processedData.map(item => sectionColors[item.section] || "#4C6EF5"),
                    borderColor: processedData.map(item => sectionColors[item.section] || "#4C6EF5"),
                    borderWidth: 1,
                    borderRadius: 4
                }]
            },
        ...
        console.error(`Error al crear gráfico de percentiles:`, error);
        container.innerHTML = `<div class="error-container">Error al crear el gráfico: ${error.message}</div>`;
    }
}
...
function createDemographicBarChart(containerId, data) {
    ...
    console.log("Datos para demographic chart:", data); // Depuración
    ...
    // Procesar datos para mostrar máximo 2 decimales
    const processedData = data.map(item => ({
        name: item.name,
        'Media de Grupo': parseFloat(parseFloat(item['Media de Grupo']).toFixed(2)),
        'Participante': parseFloat(parseFloat(item.Participante).toFixed(2))
    }));
    ...
    try {
        const chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Media del Grupo',
                        data: processedData.map(item => item['Media de Grupo']),
                        backgroundColor: '#f97316',
                        borderColor: '#f97316',
                        borderWidth: 1,
                        borderRadius: 4
                    ...
                    {
                        label: 'Participante',
                        data: processedData.map(item => item.Participante),
                        backgroundColor: '#4C6EF5',
                        borderColor: '#4C6EF5',
                        borderWidth: 1,
                        borderRadius: 4
        ...
        console.error(`Error al crear gráfico demográfico:`, error);
        container.innerHTML = `<div class="error-container">Error al crear el gráfico: ${error.message}</div>`;
    }
}
